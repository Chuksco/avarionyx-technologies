        ...
        <div className="footer-content">
          ...
          >
            ...
            <div className="social-links">
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.6l-5.177-6.77-5.91 6.77h-3.315l7.73-8.835L2.5 2.25h6.75l4.915 6.516L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/>
                </svg>
              </motion.a>
              <motion.a 
                href="#" 
